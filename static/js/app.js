(() => {
    ...
    if (document.documentElement.classList.contains("touch") || window.innerWidth < 991.98 || window.innerWidth >= 991.98) {
        ...
        document.addEventListener("click", (e => {
            ...
            if (targetElement.closest(".languages")) targetElement.closest(".languages").classList.toggle("is-open");
            if (!targetElement.closest(".languages") && document.querySelectorAll(".languages.is-open").length > 0) removeClasses(document.querySelectorAll(".languages.is-open"), "is-open");
        }));
    }
    const body = document.querySelector("body"), cursor = document.getElementById("cursor"), links = document.getElementsByTagName("a"), btns = document.getElementsByTagName("button");
